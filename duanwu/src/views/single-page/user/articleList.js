export default [{
  ...
  desc: '你好，亲爱的 iView 开发者（准开发者），很高兴你能使用到我们新上线的 iView 开发者社区。iView 从立项到现在已经经历了两年的时间，7 月 28 日是它两周岁的生日，在这一天，我们荣幸的召开了新品发布会并发布了 iView 3.0。对于初入社区的你，这篇文章将是一个很好的导引，下面就带你玩转 iView Developer。',
  ...
  desc: 'Vue Seo 服务器渲染的坑 Nuxt，分享一下我从创建到部署远程服务器的相关经验。',
  ...
  title: '相同特性组件的一种优化思路',
  desc: '本文介绍了面对大量特性相同组件的代码组织问题的一种思路，主要应用了以下知识点：require.context、render函数以及functional组件。',
  ...
  auth: {
    name: 'Jagger',
    avatar: 'https://dev-file.iviewui.com/userinfo9nQqzFLYS77QEe5n0itU2IcBQOumiFDA/avatar'
  },
  tag: ['iView', 'Vue.js', 'Webpack']
}, {
  title: '脱离 Table 组件的 Render 苦海',
  desc: '在具体开发过程中，有些使用变扭的地方（和iview无关），比如 Table 组件的自定义列实现复杂，可展开 Table 不想单独建一个 vue 文件等。 在项目开发过程中发现的小技巧分享给大家，可提高代码编写效率与可维护性。',
  ...
  auth: {
    name: 'NB阿卡',
    avatar: 'https://dev-file.iviewui.com/userinfoKukTjtAiIvUw6to7xFKeHIycrwV7rzhO/avatar'
  },
  tag: ['iView', 'Vue.js', 'Webpack']
}]
