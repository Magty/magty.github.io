          ...
          >
            ...
            <FormItem label="起止时间：" prop="date" label-for="date">
              <DatePicker
                ...
                v-width="'100%'"
                type="datetimerange"
                placeholder="选择会议的起止时间"
                element-id="date"
              ></DatePicker>
            </FormItem>
            <FormItem label="会议地点：" prop="room" label-for="room">
              <Select v-model="data.room" filterable placeholder="请选择会议室" element-id="room">
                <Option value="1" label="1 号会议室"></Option>
                <Option value="2" label="2 号会议室"></Option>
                <Option value="3" label="3 号会议室"></Option>
                <Option value="4" label="4 号会议室"></Option>
                <Option value="5" label="5 号会议室"></Option>
              </Select>
            </FormItem>
            <FormItem prop="users" label-for="users">
              <p slot="label">
                参会者
                <span v-color="'#808695'">（选填）</span>
                ：
              </p>
              <Select
                v-model="data.users"
